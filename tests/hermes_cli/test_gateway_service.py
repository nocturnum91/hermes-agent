...
class TestLaunchdRunAsUserResolution:
    ...
    def test_falls_back_to_sudo_user_when_running_as_root(self, monkeypatch):
        ...
        real_user = pwd.getpwuid(os.getuid()).pw_name  # windows-footgun: ok — macOS/POSIX-only launchd test
        if real_user == "root":
    ...
    def test_falls_back_to_current_user_when_non_root(self, monkeypatch):
        ...
        username = pwd.getpwuid(os.getuid()).pw_name  # windows-footgun: ok — macOS/POSIX-only launchd test
